...
public  class Edge extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_hxDaedalus_data_Edge(hxDaedalus.data.Edge __temp_me16)
	{
		...
		int _0 = hxDaedalus.data.Edge.INC;
		__temp_me16._id = _0;
		...
		__temp_me16.fromConstraintSegments = _1;
	}
	...
	{
		boolean _0 = this._isConstrained;
		return _0;
	}
	...
	{
		int _0 = this.fromConstraintSegments.indexOf(segment, null);
		boolean _1 = ( _0 == -1 );
		if (_1) 
		{
	...
	{
		hxDaedalus.data.Vertex _0 = this._originVertex;
		return _0;
	}
	...
	{
		hxDaedalus.data.Vertex _0 = this.get_oppositeEdge().get_originVertex();
		return _0;
	}
	...
	{
		hxDaedalus.data.Edge _0 = this._oppositeEdge;
		return _0;
	}
	...
	{
		hxDaedalus.data.Edge _0 = this._nextLeftEdge;
		return _0;
	}
	...
	{
		hxDaedalus.data.Edge _0 = this._nextLeftEdge.get_nextLeftEdge();
		return _0;
	}
	...
	{
		hxDaedalus.data.Edge _0 = this._oppositeEdge.get_nextLeftEdge().get_nextLeftEdge().get_oppositeEdge();
		return _0;
	}
	...
	{
		hxDaedalus.data.Edge _0 = this._oppositeEdge.get_nextLeftEdge().get_oppositeEdge();
		return _0;
	}
	...
	{
		hxDaedalus.data.Edge _0 = this._nextLeftEdge.get_nextLeftEdge().get_oppositeEdge();
		return _0;
	}
	...
	{
		hxDaedalus.data.Edge _0 = this._oppositeEdge.get_nextLeftEdge();
		return _0;
	}
	...
	{
		hxDaedalus.data.Face _0 = this._leftFace;
		return _0;
	}
	...
	{
		hxDaedalus.data.Face _0 = this._oppositeEdge.get_leftFace();
		return _0;
	}
	...
	{
		int _0 = this.get_originVertex().get_id();
		java.lang.String _1 = ( "edge " + _0 );
		java.lang.String _2 = ( _1 + " - " );
		int _3 = this.get_destinationVertex().get_id();
