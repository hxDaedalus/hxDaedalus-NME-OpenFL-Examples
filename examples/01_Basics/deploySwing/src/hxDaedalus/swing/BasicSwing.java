...
public  class BasicSwing extends javax.swing.JFrame implements haxe.lang.IHxObject, java.awt.event.MouseMotionListener, java.awt.event.MouseListener, java.awt.event.KeyListener
{
	...
	public    BasicSwing()
	{
		...
		hxDaedalus.swing.SwingHeader _0 = new hxDaedalus.swing.SwingHeader();
		hxDaedalus.swing.SwingHeader header = _0;
		int _1 = header.width;
		int _2 = header.height;
		this.setSize(((int) (_1) ), ((int) (_2) ));
		int _3 = javax.swing.JFrame.EXIT_ON_CLOSE;
		this.setDefaultCloseOperation(((int) (_3) ));
		int _4 = header.bgColor;
		java.awt.Color _5 = new java.awt.Color(((int) (_4) ));
		this.setBackground(((java.awt.Color) (_5) ));
		hxDaedalus.swing.Surface _6 = new hxDaedalus.swing.Surface();
		this.surface = _6;
		hxDaedalus.swing.Surface _7 = this.surface;
		this.getContentPane().add(((java.awt.Component) (_7) ));
