...
public  class DynamicObject extends haxe.lang.HxObject
{
	...
	{
		java.lang.Object _0 = ((haxe.lang.Function) (haxe.lang.Runtime.getField(this, "toString", false)) );
		haxe.lang.Function ts = ((haxe.lang.Function) (_0) );
		boolean _1 = ( ts != null );
		if (_1) 
		{
			java.lang.String _2 = haxe.lang.Runtime.toString(ts.__hx_invoke0_o());
			return _2;
		}
		
		haxe.root.StringBuf _3 = new haxe.root.StringBuf();
		haxe.root.StringBuf ret = _3;
		ret.add("{");
		boolean first = true;
		{
			int _g = 0;
			haxe.root.Array<java.lang.String> _4 = haxe.root.Reflect.fields(this);
			haxe.root.Array<java.lang.String> _g1 = _4;
			while (true)
			{
				int _5 = _g1.length;
				boolean _6 = ( _g < _5 );
				...
				haxe.root.Array<java.lang.String> _8 = _g1;
				java.lang.String _9 = _8.__get(_g);
				java.lang.String f = _9;
				 ++ _g;
				if (first) 
				{
					first = false;
				...
				ret.add(f);
				ret.add(" : ");
				java.lang.Object _10 = haxe.root.Reflect.field(this, f);
				ret.add(_10);
			}
		...
		ret.add("}");
		java.lang.String _12 = ret.toString();
		return _12;
	}
