...
public  class Timer extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxe_Timer(haxe.Timer __temp_me7, int time_ms)
	{
		...
		java.util.Timer _0 = new java.util.Timer();
		__temp_me7.timer = _0;
		haxe._Timer.TimerTask _1 = new haxe._Timer.TimerTask(((haxe.Timer) (__temp_me7) ));
		java.util.TimerTask _2 = __temp_me7.task = _1;
		__temp_me7.timer.scheduleAtFixedRate(((java.util.TimerTask) (_2) ), ((long) (time_ms) ), ((long) (time_ms) ));
	}
